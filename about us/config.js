...
module.exports = {
  mongodb: {
    ...
    adminUsername: process.env.ME_CONFIG_MONGODB_ADMINUSERNAME || 'wtyo1768',
    adminPassword: process.env.ME_CONFIG_MONGODB_ADMINPASSWORD || 's124930654',
  ...
  site: {
    ...
    port:             process.env.VCAP_APP_PORT                 || 11998,
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'wtyo1768',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 's124930654',
  },
